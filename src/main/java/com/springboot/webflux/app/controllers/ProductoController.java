...
public class ProductoController {
	...
	@PostMapping("/form")
	public Mono<String> guardar(@Valid Producto producto, 
		...
		if(result.hasErrors()) {
			...
			.thenReturn("redirect:/listar?success=Producto+creado+con+exito");
		}
	}
	...
	public Mono<String> eliminar(@PathVariable String id) {
		return service.findById(id)
				.defaultIfEmpty(new Producto())
				  ...
				  .flatMap(p -> {
					  log.info("Eliminando producto con Id: " + p.getId());
					  log.info("Eliminando producto con nombre: " + p.getNombre());
